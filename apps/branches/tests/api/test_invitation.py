...
from branches.api.views import BranchAdminInviteView, BranchAdminCompleteInvitationView
from branches.tests.factories import BranchFactory, BranchAdminFactory
...
class TestBranchAdminInviteView:
    ...
    def test_invite_not_owner_permission_denied(self, api_rf: APIRequestFactory):
        ...
        # The error format is {'errors': [{'code': 'invalid', 'detail': '...', 'field': 'branch'}]}
...
class TestBranchAdminCompleteInvitationView:
    ...
    def test_complete_success(self, api_rf: APIRequestFactory):
        user = UserFactory(role=User.Role.BRANCH_ADMIN)
        ...
        assert response.data["message"] == "Password set and account activated successfully."
